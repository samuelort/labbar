...
public class SnakeModel extends GameModel {
    ...
    /**
     * The SnakeModel main construcor.
     */
    public SnakeModel() {
    ...
    /**
     * Adds an new fruit to empty random position.
     */
    ...
    public void gameUpdate(final int lastKey) throws GameOverException {
        ...
        /**
         * Check if your snake fills the entire board = you have won!
         */
        if(this.score == (getGameboardSize().width*getGameboardSize().height) - 1){
            throw new GameOverException(this.score);
        }
    ...
    /**
     * Checks if you hit any wall.
     * @param pos, takes current pos.
